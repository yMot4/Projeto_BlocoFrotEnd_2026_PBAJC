...
export default function Detalhes() {
    ...
    const carros = [
        ...
        { id: 3, modelo: "Chevrolet Onix",  lugares: 5, cambio: "Automático", quilometragem: "Livre", precoPorDia: 149.9, foto: null },
        { id: 4, modelo: "Jeep Renegade",   lugares: 5, cambio: "Automático", quilometragem: "Livre", precoPorDia: 219.9, foto: null },
    ];

    const carroSelecionado = carros.find((carro) => carro.modelo === valueCarro);
    const valorCarro = carroSelecionado ? carroSelecionado.precoPorDia * count : 0;
        ...
        <div className={style.box_passagem}>
            ...
            <section>
                <div className={style.passagem_localidade}>
                    ...
                    <h3><PlaneTakeOff size="lg" />{aeroPartida}</h3>
                </div>
            </section>
            ...
            <section>
                <div className={style.passagem_localidade}>
                    ...
                    <h3><PlaneLand size="lg" />{aeroChegada}</h3>
                </div>
            </section>
        </div>
    );
            ...
            <div className={style.container}>
                ...
                <div className={style.container_detalhes}>
                    <div className={style.box_padding}>
                        ...
                        {renderVoo({
                            aeroPartida: aeroPartidaIda, aeroChegada: aeroChegadaIda,
                            dataPartida: dataPartidaIda, horaPartida: horaPartidaIda,
                            dataChegada: dataChegadaIda, horaChegada: horaChegadaIda,
                            titulo: `Voo para ${aeroChegadaIda}`,
                        })}

                        {aeroPartidaVolta && renderVoo({
                            aeroPartida: aeroPartidaVolta, aeroChegada: aeroChegadaVolta,
                            dataPartida: dataPartidaVolta, horaPartida: horaPartidaVolta,
                            dataChegada: dataChegadaVolta, horaChegada: horaChegadaVolta,
                        ...
                        <div className={style.section_opcionais}>
                            ...
                            <select
                                ...
                                value={valueCarro}
                                onChange={(e) => { setValueCarro(e.target.value); setCount(1); }}
                            >
                                <option value="nenhum">Nenhum</option>
                                {carros.map((carro) => (
                                    <option key={carro.id} value={carro.modelo}>{carro.modelo}</option>
                                ))}
                            </select>
                            ...
                            {valueCarro !== "nenhum" && carroSelecionado && (
                                <>
                                    ...
                                    <div className={style.carro_section_valor}>
                                        ...
                                        <span>
                                            R$ {(carroSelecionado.precoPorDia * count).toLocaleString("pt-BR", {
